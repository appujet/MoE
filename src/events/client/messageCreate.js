const { Message, Collection, PermissionFlagsBits, ActionRowBuilder, EmbedBuilder, ChannelType } = require("discord.js");
const Event = require("@structures/Event");
const Context = require("@root/src/structures/Context");
const { getPrefix, createGuildDb } = require("@handlers/functions");
module.exports = class MessageCreate extends Event {
    ...
    async run(message) {
        ...
        await createGuildDb(message.guild.id);
        const prefix = await getPrefix(message.guild.id);
        const color = this.client.config.color ? this.client.config.color : "#59D893"
